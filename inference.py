...
if __name__ == '__main__':
    ...
    _, model = dbnet()
    model.load_weights('checkpoints/2020-05-12/db_85_1.7676_0.9331.h5', by_name=True, skip_mismatch=True)
    for image_path in glob.glob(osp.join('/data/realdata/tmp/', '*.jpg')):
        ...
        bitmap = p > 0.3
        boxes, scores = boxes_from_bitmap(p, bitmap, w, h, box_thresh=0.5)
        boxes = boxes.tolist()
        for box in boxes:
